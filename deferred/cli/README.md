> Historical reference only. This package is excluded from the active workspace and is not a fallback runtime. See [current CLI documentation](../../docs/cli.md). Commands below describe the retired tooling.
