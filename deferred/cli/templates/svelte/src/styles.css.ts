...
globalStyle("*, *::before, *::after", {
  "@media": {
    "(prefers-reduced-motion: reduce)": { scrollBehavior: "auto", transitionDuration: ".01ms" },
  },
});
...
export const output = style({
  display: "block",
  fontSize: "clamp(70px, 20cqw, 94px)",
  fontWeight: 650,
  lineHeight: ".84",
  letterSpacing: "-.075em",
...
export const controlButton = style({
  ...
  selectors: {
    "&:focus-visible": {
      outline: `3px solid color-mix(in srgb, ${theme.accent} 34%, transparent)`,
      outlineOffset: 2,
    },
  },
});
...
export const exportSurface = style({
  minHeight: "100vh",
  padding: "34px 38px",
  background: theme.surface,
  color: theme.ink,
