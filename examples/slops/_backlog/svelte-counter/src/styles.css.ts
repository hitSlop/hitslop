...
export const counterRender = style({ position: "fixed", inset: "0 auto auto 0", display: "none !important", width: 512, height: 512, placeItems: "center", overflow: "hidden", background: "transparent" });
export const iconTile = style({ display: "grid", placeItems: "center", width: 464, height: 464, border: `18px solid ${theme.ink}`, borderRadius: 72, background: theme.accent });
globalStyle(`${iconTile} span`, { marginTop: -18, color: theme.surface, fontSize: 280, fontWeight: 600, lineHeight: 1 });
