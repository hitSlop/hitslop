...
const swing = keyframes({ from: { transform: "rotate(-22deg)" }, to: { transform: "rotate(22deg)" } });
const metal = "#382f2a";
const recess = "#29241f";
const dark = "#110e0c";
...
globalStyle(".pendulum-arm.swinging", { animation: `${swing} var(--speed, .5s) ease-in-out infinite alternate` });
...
globalStyle('html[data-slop-capture="static"] .pendulum-arm', { transform: "rotate(-16deg)" });
globalStyle('[data-slop-render="icon"]', { display: "none !important", width: 512, height: 512, background: "transparent" });
globalStyle('html[data-slop-renderer="true"][data-slop-capture="icon"] .metronome-shell, html[data-slop-renderer="true"][data-slop-capture="icon"] .store-error', { display: "none !important" });
globalStyle('html[data-slop-renderer="true"][data-slop-capture="icon"] [data-slop-render="icon"]', { display: "grid !important", placeItems: "center" });
globalStyle(".metronome-render", { width: 512, height: 512 });
...
globalStyle(".pendulum-arm.swinging", { "@media": { "(prefers-reduced-motion: reduce)": { animation: "none" } } });
