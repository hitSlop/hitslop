...
public struct SlopManifest: Codable, Sendable {
    ...
    /// Minimum compatible host runtime; generated by the build.
    ...
    public init(schema: Schema, author: SlopAuthor, categories: [SlopCategory], description: String, presentation: SlopPresentation, runtime: String, slug: String, title: String) {
        self.schema = schema
        self.author = author
