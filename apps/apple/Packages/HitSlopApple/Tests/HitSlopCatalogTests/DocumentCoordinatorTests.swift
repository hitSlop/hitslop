...
func coordinatorFixture(in directory: URL, index: Int) throws -> URL {
    ...
    let manifest = #"{"$schema":"https://api.hitslop.com/schemas/v1/manifest.schema.json","runtime":"1.0.0","author":{"name":"Native test"},"slug":"fixture-\#(index)","title":"Fixture \#(index)","description":"Disposable fixture","categories":["utilities"],"presentation":{"width":380,"height":280,"resizable":true}}"#
