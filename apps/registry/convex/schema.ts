...
const schema = defineSchema({
  ...
  templates: defineTable({
    ...
    currentReleaseId: v.optional(v.id("releases")), currentReleaseNumber: v.number(), downloads: v.number(), installs: v.number(), favorites: v.number(), popularityScore: v.number(), createdAt: v.number(), updatedAt: v.number(),
