...
- Storage is implicit and ID-free. Never add storage declarations or template
  release versions to the manifest. The runtime requirement is generated by the build.
