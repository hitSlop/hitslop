...
import { runtimeVersionPattern } from "./document-runtime.js";

export const manifestSchemaURL = "https://api.hitslop.com/schemas/v1/manifest.schema.json" as const;
export const authoringManifestSchemaURL = "https://api.hitslop.com/schemas/v1/authoring-manifest.schema.json" as const;
...
export const SlopAuthoringManifestSchema = Type.Object({
  $schema: Type.Literal(authoringManifestSchemaURL), ...manifestProperties,
}, { additionalProperties: false, title: "SlopAuthoringManifest" });
export const SlopManifestSchema = Type.Object({
  $schema: Type.Literal(manifestSchemaURL), ...manifestProperties,
  runtime: Type.String({ pattern: runtimeVersionPattern, description: "Minimum compatible host runtime; generated by the build." }),
...
export type SlopAuthoringManifest = Type.Static<typeof SlopAuthoringManifestSchema>;
...
export const parseAuthoringManifest = (input: unknown): SlopAuthoringManifest => validate(SlopAuthoringManifestSchema, input);
